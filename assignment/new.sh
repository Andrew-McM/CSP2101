...
5) Exit the program.\n"
    ...
    case $action in
        ...
        "1")
            ...
            do
                ...
                if [[ ${imageName^^} == 'CANCEL' ]]; then
                    ...
                    wget -nv https://secure.ecu.edu.au/service-centres/MACSC/gallery/152/${imageName^^}.jpg
                    if [[ $? == 0 ]]; then
        ...
        "2")
            echo -e "${cyan}\nDownloading all images to $saveDir, please wait one moment...${clear}"
            for i in {1533..2042}; do
                if [[ -f "DSC0$i.jpg" ]]; then
                    ...
                    if wget -q --method=HEAD https://secure.ecu.edu.au/service-centres/MACSC/gallery/152/DSC0${i}.jpg; then
                        wget -nv https://secure.ecu.edu.au/service-centres/MACSC/gallery/152/DSC0${i}.jpg
            ...
            for c in $ranNum; do
                if [[ -f "DSC0$c.jpg" ]]; then
                    ...
                    if wget -q --method=HEAD https://secure.ecu.edu.au/service-centres/MACSC/gallery/152/DSC0${c}.jpg; then
                        wget -nv https://secure.ecu.edu.au/service-centres/MACSC/gallery/152/DSC0${c}.jpg
